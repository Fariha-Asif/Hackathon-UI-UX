...
const TopNav = () => {
    return (
        <div className="flex w-[870px] lg:w-[1440px] h-[34px] xl:h-[38px] bg-black">
            {/* 20% off Announcement with Shop Now */}
            <div className="w-[301px] lg:w-[596px] h-[16px] xl:h-6 gap-8px">
                <p className="w-[451px] h-[19px] mt-[9px] ml-[170px] lg:ml-[500px] font-normal text-xs lg:text-sm leading-[18px] lg:leading-[18.9px] text-[#FFFFFF]">
